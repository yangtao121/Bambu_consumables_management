...
from app.api.routers import color_mappings, jobs, mappings, material_ledger, printers, realtime, reports, spools, stocks, trays
...
app.include_router(material_ledger.router)
app.include_router(color_mappings.router)
