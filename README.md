...
![系统界面概览](docs/images/collage.png)
...
![打印机管理界面](docs/images/printers.png)
...
![耗材库存管理界面](docs/images/stocks.png)
...
![数据报表界面](docs/images/reports.png)
...
![主页/仪表板](docs/images/dashboard.png)
