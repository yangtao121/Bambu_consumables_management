...
![Printer Management Interface](docs/images/printers.png)
...
![Material Inventory Interface](docs/images/stocks.png)
...
![Print Job History Interface](docs/images/jobs.png)
...
![Reports Interface](docs/images/reports.png)

## 系统界面展示

### 主页/仪表板

系统的主页提供直观的仪表板界面，展示关键统计信息和快速导航入口：
